...
<body id="page-top">
  <table>
     <tr>
        ...
        <td>
          <div style="margin: 0 auto;width: 130px; height:0px">   
             <p style="height:0px" alt="me" style="width: 130px">Fecha:{{date('Y-m-d') }}</p>
             <p style="height:0px" alt="me" style="width: 130px">Hora:{{date('H:i:s') }}</p>
          </div>            
        </td>
      </tr>
  </table>
