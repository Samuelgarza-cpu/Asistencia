                      ...
                      <form method="POST" action="{{Request::url()}}" id="frm" class="needs-validation" novalidate>
                        @csrf
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="name" placeholder="Ingrese el nombre del ocupación" name="name" required/>
                              <div class="invalid-feedback">
                                Favor de ingresar el nombre de la ocupación
                              </div>
                          </div>
                  </div>
...
@section('jsForm')
  <script src="../assets/js/Employment.js"></script>
@endsection