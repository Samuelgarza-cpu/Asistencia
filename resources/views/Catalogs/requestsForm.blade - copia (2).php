...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <form method="POST" id="formRequest" action="{{Request::url()}}" class="needs-validation" validate>
      @csrf
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link disabled" id="beneficiaryGeneralData-tab" data-toggle="tab" href="#beneficiaryGeneralData" role="tab" aria-controls="beneficiaryGeneralData" aria-selected="false">Datos generales de beneficiario</a>
        </li>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="requestGeneralData" role="tabpanel" aria-labelledby="requestGeneralData-tab">
              ...
              <div id="{{'fDP-'.$i}}">
                ...
                <div class="form-row">
                  <div class="form-group col-md-3">
                    ...
                    <select id="{{'suppliers_id'.$i}}" name="{{'suppliers_id'.$i}}" class="form-control" required>
                      <option value="">Selecciona...</option>
                        @if(isset($suppliers))
                          @foreach($suppliers[$i] as $element)
         ...
         <div id="products"></div> 
          ...
          <button type="submit" id="requestGeneralData-1"  onclick="nextNavTab(this,event)" class="btn btn-primary float-right" style="margin-right: 3px;">Siguiente</button>
            ...
            <div class="form-group col-md-4">
              ...
              @if(session('department_institute_id') <> 4)
                  @if(isset($economicData))
                    <input type="text" disabled class="form-control" id="income" name="income" placeholder="Ingresa los ingresos mensuales del beneficiario" required value="{{$economicData['income']}}">
                  @else
                    <input type="text" disabled class="form-control" id="income" name="income" placeholder="Ingresa los ingresos mensuales del beneficiario" required>
                  @endif
              @else
                  @if(isset($economicData))
