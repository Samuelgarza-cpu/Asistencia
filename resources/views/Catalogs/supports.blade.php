                      ...
                      <form method="POST" action="{{Request::url()}}" id="frm" class="needs-validation" novalidate>
                        @csrf
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="name" placeholder="Ingrese el nombre del apoyo" name="name" required/>
                              <div class="invalid-feedback">
                                Favor de ingresar el nombre del apoyo
                              </div>
                          </div>
                          {{-- <div class="form-group">
                            <label for="departments_institutes_id">Departamento:</label>
                            <select type="text" class="form-control" id="departments_institutes_id" name="departments_institutes_id">
                                <option value="">seleccione...</option>
                                @if(isset($institutes))
                                    @foreach($institutes as $element)
                                    <option value="{{$element['department_institute_id']}}">{{$element['fullname']}}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div> --}}
