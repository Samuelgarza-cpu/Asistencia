                      ...
                      <form method="POST" action="{{Request::url()}}" id="frm" class="needs-validation" enctype="multipart/form-data" novalidate>
                        @csrf
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="name" placeholder="Ingrese el nombre del departamento" name="name" required/>
                              <div class="invalid-feedback">
                                Favor de ingresar el nombre del departamento
                              </div>
                          </div>
                  </div>
