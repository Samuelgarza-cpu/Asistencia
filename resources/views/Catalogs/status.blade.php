                      ...
                      <form method="POST" action="{{Request::url()}}" id="frm" class="needs-validation" novalidate>
                        @csrf
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="name" placeholder="Ingrese el nombre del estado" name="name" required/>
                              <div class="invalid-feedback">
                                Favor de ingresar el nombre del estado
                              </div>
                          </div>
                          <div class="form-group">
                            <label for="color">Color:</label>
                            <input type="text" class="form-control" id="color" value="#2FB6FF" name="color" required/>
                            <div class="invalid-feedback">
                              Favor de ingresar el seleccionar el color
                            </div>
                        </div>
                        {{-- <div class="form-group">
