    ...
    public function updated(Request $request, $id){
        ...
        if(is_numeric($id)){
            ...
            if($requisition->type != 'ts')
            {
                ...
                $requi = Requisition::leftJoin('vrequests_suppliersproducts as rSP','requests.id','rSP.requests_id')
                                                 ->join('suppliers_products as P','rsP.products_id','P.products_id')
                                                 ->where('requests_id', '=', $requisition->id)->get();
                ...
                if(isset($requi) && $requi->count() > 0)
                {
                            ...
                            {
                                $requisition['supplier_id'.($key + 1)] = $value->supplier_id;                   
                                $requisition['product_id'.($key + 1)] = $value->products_id; 
